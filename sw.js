const CACHE_NAME = 'yulia-top3-v1-2-0-three-methods';
const OFFLINE_URL = './index.html';
const LIVE_FILE = './top3-history.json';
const ASSETS = [
  './index.html', './repair.html', './styles.css?v=1.2.0', './top3-storage-indexeddb.js?v=1.0.1', './app.js?v=1.2.0',
  './mirror-method.css?v=1.2.0', './mirror-method.js?v=1.2.0',
  './triple-methods.css?v=1.2.0', './triple-methods.js?v=1.2.0',
  './top3-data.js?v=1.2.0', './manifest.webmanifest',
