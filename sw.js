const CACHE_NAME = 'yulia-top3-v1-2-10-m6-repeat-family-v2';
const OFFLINE_URL = './index.html';
const LIVE_FILE = './top3-history.json';
const ASSETS = [
  './index.html', './repair.html', './styles.css?v=1.2.10', './top3-storage-indexeddb.js?v=1.0.1', './app.js?v=1.2.10', './live-source-fix.js?v=1.2.10',
  './mirror-method.css?v=1.2.10', './mirror-method.js?v=1.2.10',
  './triple-methods.css?v=1.2.10', './m6-repeat-family-v2.js?v=1.2.10', './triple-methods.js?v=1.2.10',
  './top3-data.js?v=1.2.10', './manifest.webmanifest',
...
self.addEventListener('fetch', event => {
  ...
  const isLive = url.pathname.endsWith('/top3-history.json');
  if (isLive) {
