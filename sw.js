const CACHE_NAME = 'yulia-top3-v1-2-2-direct-api';
...
const ASSETS = [
  ...
  './mirror-method.css?v=1.2.2', './mirror-method.js?v=1.2.2',
  './triple-methods.css?v=1.2.2', './triple-methods.js?v=1.2.2',
  './top3-data.js?v=1.2.2', './manifest.webmanifest',
